...
from ikwen_webnode.commarketing.views import ChangeSmartObject, SmartCategoryList, delete_smart_object, \
...
urlpatterns = patterns(
    ...
    url(r'^homepageSection/(?P<object_id>[-\w]+)/$', permission_required('commarketing.ik_manage_marketing')(ChangeHomepageSection.as_view()), name='change_homepage_section'),
