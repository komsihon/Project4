...
from web.models import Banner, SmartCategory, SLIDE
...
class MarketingViewsTestCase(unittest.TestCase):
    ...
    def test_SmartCategoryList(self):
        ...
        """
        self.client.login(username='member3', password='admin')
        response = self.client.get(reverse('web:smart_category_list'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_ChangeSmartObject_with_new_banner(self):
        ...
        """
        self.client.login(username='member3', password='admin')
        self.client.post(reverse('web:change_smart_object', args=('banner', )),
                         {'smart_object_id': '',
                          'title': 'Store Opening',
    ...
    def test_ChangeSmartObject_with_existing_banner(self):
        ...
        """
        self.client.login(username='member3', password='admin')
        response = self.client.post(reverse('web:change_smart_object', args=('banner', )),
    ...
    def test_ChangeSmartObject_with_new_smart_category(self):
        ...
        """
        self.client.login(username='member3', password='admin')
        self.client.post(reverse('web:change_smart_object', args=('smartcategory', )),
                         {'smart_object_id': '',
                          'title': 'Best Sellers',
                          'content_type': 'Categories',
    ...
    def test_ChangeSmartObject_with_existing_smart_category(self):
        ...
        """
        self.client.login(username='member3', password='admin')
        response = self.client.post(reverse('web:change_smart_object', args=('smartcategory', )),
    ...
    def test_set_smart_object_content(self):
        ...
        """
        self.client.login(username='member3', password='admin')
        response = self.client.get(reverse('web:set_smart_object_content', args=('add', )),
                                   {'smart_object_id': '56a9b37b3301e0706b549223',
        ...
        response = self.client.get(reverse('web:set_smart_object_content', args=('remove', )),
                                   {'smart_object_id': '56a9b37b3301e0706b549223',
    ...
    def test_delete_smart_object(self):
        ...
        """
        self.client.login(username='member3', password='admin')
        response = self.client.get(reverse('web:delete_smart_object'),
